# -*- coding: utf-8 -*-
"""
Загрузка справочника «Классификатор единиц измерения» из 1С в SQLite.
...
{limit_clause}    Каталог.Ссылка КАК Ссылка,
    ...
    Каталог.МеждународноеСокращение КАК МеждународноеСокращение
ИЗ
    Справочник.КлассификаторЕдиницИзмерения КАК Каталог
"""
...
def load_units_classifier(
    ...
    _log("=" * 80)
    _log("ЗАГРУЗКА СПРАВОЧНИКА «КЛАССИФИКАТОР ЕДИНИЦ ИЗМЕРЕНИЯ»")
    _log("=" * 80)
