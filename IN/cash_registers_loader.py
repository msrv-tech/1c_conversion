# -*- coding: utf-8 -*-
"""
Загрузка справочника «Кассы» из 1С в SQLite.
...
def load_cash_registers(
    ...
    _log("=" * 80)
    _log("ЗАГРУЗКА СПРАВОЧНИКА «КАССЫ»")
    _log("=" * 80)
    ...
    if not rows:
        _log("Предупреждение: записи справочника «Кассы» не найдены.")
